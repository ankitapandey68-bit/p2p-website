      ...
      <div style={styles.main} className="footer-main">
        <div style={styles.leftSection}>
          <div style={styles.brand}>
            ...
            <div style={styles.socialRow}>
              ...
              <a
                ...
                title={item.name}
                onMouseEnter={(e) => {
                  e.currentTarget.style.background = 'linear-gradient(135deg, #4DEEEA, #60A5FA)';
          ...
          <div style={styles.column}>
            ...
            <Link to="/solutions" style={styles.link}>Our Solutions</Link>
            <Link to="/" style={styles.link}>Why Choose Us</Link>
            <Link to="/#contact" style={styles.link}>Contact</Link>
          </div>

          <div style={styles.column}>
            <h4 style={styles.columnTitle}>Solutions</h4>
            <Link to="/solutions" style={styles.link}>IT & Network</Link>
            <Link to="/solutions" style={styles.link}>CCTV & Surveillance</Link>
            <Link to="/solutions" style={styles.link}>OFC & Fiber</Link>
            <Link to="/solutions" style={styles.link}>Digital Solutions</Link>
          </div>
